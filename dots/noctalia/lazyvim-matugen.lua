...
function M.setup()
  ...
  -- Snacks dashboard
  hi('SnacksDashboardHeader',  { fg = '{{colors.outline_variant.default.hex}}', bg = '{{colors.background.default.hex}}' })
  hi('SnacksDashboardDesc',    { fg = '{{colors.on_surface.default.hex}}',      bg = '{{colors.background.default.hex}}' })
  hi('SnacksDashboardIcon',    { fg = '{{colors.on_primary.default.hex}}',      bg = '{{colors.background.default.hex}}' })
  hi('SnacksDashboardKey',     { fg = '{{colors.error.default.hex}}',           bg = '{{colors.background.default.hex}}' })
  hi('SnacksDashboardFooter',  { fg = '{{colors.outline.default.hex}}',         bg = '{{colors.background.default.hex}}' })
  hi('SnacksDashboardTitle',   { fg = '{{colors.on_surface.default.hex}}',      bg = '{{colors.background.default.hex}}', bold = true })
  hi('SnacksDashboardNormal',  { fg = '{{colors.on_surface.default.hex}}',      bg = '{{colors.background.default.hex}}' })
