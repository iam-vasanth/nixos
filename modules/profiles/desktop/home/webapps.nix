...

{
  xdg.desktopEntries = {
    ...
    notion = {
      ...
      icon = "${pkgs.notion-app-enhanced}/share/icons/hicolor/256x256/apps/notion.png";  # example if you have another package
      categories = [ "Office" "Network" ];
      startupWMClass = "webapp-notion";
    };
  };

  # Optional: make sure icons folder is watched
  xdg.enable = true;
}
